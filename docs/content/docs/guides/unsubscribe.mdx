...
The suppression list is available over the API as `GET`, `POST` and `DELETE /suppressions`. See [deliverability and ops](/api/reference/deliverability-ops/#list-the-suppression-list).
