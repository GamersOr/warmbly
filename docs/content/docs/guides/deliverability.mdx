...
Verdicts age: an address is checked again after 90 days (30 for an inconclusive verdict), because mailboxes get created and closed. A verdict a teammate set by hand never expires.
